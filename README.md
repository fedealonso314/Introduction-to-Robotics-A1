...
The system is a 4-DOF robotic manipulator designed for the automated management and correction of books that are already placed within a bookshelf or shelving unit.	

Motivation: The goal is to maintain the uniformity and orderliness of the shelf, which facilitates both human access and automated inventory processes. 
The key tasks focus entirely on correcting physical placement errors:
...
<details>
<summary> Trajectory and Workspace
...
### [Workspace Analysis](URDFRobotSimulation.m)
...
![Image](https://github.com/user-attachments/assets/11b6ce5b-f9b4-4f96-a1b0-4186249287e3)
</details>
